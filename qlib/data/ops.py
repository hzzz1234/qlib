...
def register_all_ops(C):
    ...
    from qlib.data.pit import P, PRef, PreFactor, FR, BR, FAdjust, BAdjust  # pylint: disable=C0415

    Operators.reset()
    Operators.register(OpsList + [P, PRef, PreFactor, FR, BR, FAdjust, BAdjust])
